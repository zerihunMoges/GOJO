...
class FirstNameFieldValidator {
   static String? validate(String value){
    return (value.isEmpty || value == null)  ? "please enter your first name " : null;
  }
}

class LastNameFieldValidator {
   static String? validate(String value){
    return (value.isEmpty || value == null)  ? "please enter your last name " : null;
  }
}
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            validator: (String? value) => 
                              FirstNameFieldValidator.validate(firstCtrl.text)
                          ),
                        ),
                        SizedBox(
                          height: 10,
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            validator: (String? value) => 
                              LastNameFieldValidator.validate(lastCtrl.text)
                          ),
                        ),
                        SizedBox(
                          height: 20,
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              validator: (String? value) => 
                                UserNameCtrlFieldValidator.validate(usernameCtrl.text)
                          ),
                        ),
                        SizedBox(
                          height: 20,
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            validator: (String? value) => 
                              EmailCtrlFieldValidator.validate(emailCtrl.text)
                          ),
                        ),
                        SizedBox(
                          height: 20,
