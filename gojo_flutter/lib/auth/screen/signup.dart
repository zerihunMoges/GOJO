...
class ComfirmPasswordFieldValidator {
   static String? validate(String value){
    return (value.isEmpty || value == null)  ?  "please make sure to write the same password " : null;
  }
}
            ...
            children: <Widget>[
              ...
              SizedBox(
                ...
                child: TextFormField(
                  ...
                  validator: (value) => 
                    NameFieldValidator.validate(nameController.text)
                ),
              ),
              ...
              SizedBox(
                ...
                child: TextFormField(
                  ...
                  validator: (value) => 
                    LastNameFieldValidator.validate(lastNameController.text)
                ),
              ),
              SizedBox(
                height: 15,
              ...
              SizedBox(
                ...
                child: TextFormField(
                  ...
                  validator: (value) => 
                    UserNameFieldValidator.validate(usernameController.text)
                ),
              ),
              SizedBox(
                height: 15,
              ...
              SizedBox(
                ...
                child: TextFormField(
                  ...
                  validator: (value) => 
                    PasswordFieldValidator.validate(passwordController.text)
                ),
              ),
              ...
              SizedBox(
                ...
                child: TextFormField(
                  ...
                  validator: (value) => 
                    ComfirmPasswordFieldValidator.validate(confirmpasswordController.text)
                ),
              ),
