                      ...
                      child: RaisedButton(
                        ...
                        onPressed: state is LoginIn
                            ...
                            : () {
                                ...
                                authBloc.add(Signup(email: emailController.text, name: nameController.text, last_name: lastNameController.text, username:usernameController.text,password:passwordController.text));
                              },
                      ));
                },
              ),
